 ...
 * {@link org.springframework.transaction.PlatformTransactionManager} interface. This will be set by the
...
public abstract class AbstractTransactionalSpringContextTests extends AbstractDependencyInjectionSpringContextTests {
	 ...
	 *
	 * @throws org.springframework.transaction.TransactionException if starting the transaction failed
	 */
